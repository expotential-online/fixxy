...
import fixxy.quickfix.QuickFixVersion.*
...
internal class QuickFixEnumeratedFieldValueHelperTest {
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_4_0() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_4_0)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_4_1() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_4_1)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_4_2() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_4_2)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_4_3() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_4_3)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_4_4() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_4_4)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_5_0() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_5_0)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_5_0_sp_1() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_5_0_sp_1)
    }
    ...
    fun testAllQuickFixFieldsWithEnumeratedFieldValues_Fix_5_0_sp_2() {
        testAllQuickFixFieldsWithEnumeratedFieldValuesForFixVersion(Fix_5_0_sp_2)
    }
    ...
    companion object {
        ...
        const val AllQuickFixFieldsWithEnumeratedFieldValuesTestNameSuffix = "All QuickFix fields with enumerated values are correctly processed"
    }
}